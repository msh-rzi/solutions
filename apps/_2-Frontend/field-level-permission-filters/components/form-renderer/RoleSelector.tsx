...
export const RoleSelector = memo(function RoleSelector({ value, onChange }: RoleSelectorProps) {
  return (
    <Paper shadow="sm" p="md" withBorder>
      <Group justify="space-between" align="center" wrap="wrap" gap="md">
        ...
        <SegmentedControl value={value} onChange={(v) => onChange(v as UserRole)} data={ROLE_OPTIONS} size="md" radius="md" />
      </Group>
    </Paper>
  );
});
